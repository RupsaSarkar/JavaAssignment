...
public class Movie_DetailsList {
	static Set<Movie_Details>mv=new TreeSet<Movie_Details>(new MovieNameComparator());
	 static Movie_Details m1=new Movie_Details("Forrest Gump","Tom Hanks","Robin Wright","Drama");
	 static Movie_Details m2=new Movie_Details("Catch me if you can","Leonardo DiCaprio","Amy Adams","Crime");
	 static Movie_Details m3=new Movie_Details("The Shawshank Redemption","Tim Robbins","Renee Blaine","Comedy");
	...
	public  static void remove_moviesAll() {
		...
		mv.removeAll(mv);
		System.out.println("All Movie details removed");
	}
		...
		for(Movie_Details m:mv) {
			if(n.equalsIgnoreCase(m.mov_Name)) {
				System.out.println("Movie name: "+m
						.mov_Name+"Lead Actor Name: "+m.lead_actor+"Lead Actress Name: "+m.lead_actress+"Genre: "+m.genre);
				
			}
		}
			
	}
	public static void find_movie_by_mov_genre(String g) {
	...
	public static void sortmov(String sort) {
		if(sort.equalsIgnoreCase("Movie Name")) {
			  ...
			  Movie_Details mn1=new Movie_Details("Forrest Gump","Tom Hanks","Robin Wright","Drama");
			  Movie_Details mn2=new Movie_Details("Catch me if you can","Leonardo DiCaprio","Amy Adams","Crime");
			  Movie_Details mn3=new Movie_Details("The Shawshank Redemption","Tim Robbins","Renee Blaine","Comedy");
			  ...
			  Movie_Details ma1=new Movie_Details("Forrest Gump","Tom Hanks","Robin Wright","Drama");
			  Movie_Details ma2=new Movie_Details("Catch me if you can","Leonardo DiCaprio","Amy Adams","Crime");
			  Movie_Details ma3=new Movie_Details("The Shawshank Redemption","Tim Robbins","Renee Blaine","Comedy");
			  ...
			  Movie_Details maa1=new Movie_Details("Forrest Gump","Tom Hanks","Robin Wright","Drama");
			  Movie_Details maa2=new Movie_Details("Catch me if you can","Leonardo DiCaprio","Amy Adams","Crime");
			  Movie_Details maa3=new Movie_Details("The Shawshank Redemption","Tim Robbins","Renee Blaine","Comedy");
			  ...
			  Movie_Details g1=new Movie_Details("Forrest Gump","Tom Hanks","Robin Wright","Drama");
			  Movie_Details g2=new Movie_Details("Catch me if you can","Leonardo DiCaprio","Amy Adams","Crime");
			  Movie_Details g3=new Movie_Details("The Shawshank Redemption","Tim Robbins","Renee Blaine","Comedy");
	...
	public  static void main(String[] args) {
		...
		find_movie_by_mov_genre(genre);
		System.out.println("Enter on the basis of which you want to sort");
